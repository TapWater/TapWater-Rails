...
class DrinksControllerTest < ActionController::TestCase
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post :create, drink: { category: @drink.category, drink_date: @drink.drink_date, user_id: @drink.user_id, uuid: @drink.uuid }
    end
  ...
  test "should update drink" do
    patch :update, id: @drink, drink: { category: @drink.category, drink_date: @drink.drink_date, user_id: @drink.user_id, uuid: @drink.uuid }
    assert_redirected_to drink_path(assigns(:drink))
  end
